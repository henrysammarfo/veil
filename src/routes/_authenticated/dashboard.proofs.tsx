...
function ProofsPage() {
  const { proofs, ticks } = useMockData();
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-4 sm:flex sm:flex-wrap sm:justify-between">
        <div className="min-w-0">
          ...
          <p className="mt-2 max-w-xl text-sm text-[color:var(--ds-muted)]">
            ...
            Filter by tag, search by hash, copy any line — or open a proof for full metadata.
          </p>
        </div>
      ...
      <DSCard className="!py-4">
        <p className="text-[12px] text-[color:var(--ds-muted)]">
          ...
          <Link to="/dashboard/proofs" className="underline">Filter by tag</Link>{" "}
