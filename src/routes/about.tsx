...
function AboutPage() {
  return (
    <PageShell>
      <Reveal>
        <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-white/40">About</p>
      ...
      <div className="mt-20 grid gap-16 md:grid-cols-12">
        ...
        <Reveal delay={0.2} className="md:col-span-5">
          <dl className="space-y-6 border-l border-white/10 pl-6 font-mono text-sm">
            <div>
              <dt className="text-[10px] uppercase tracking-[0.2em] text-white/40">Track</dt>
              <dd className="mt-1 text-white">DeepBook · Sui Overflow 2026</dd>
            </div>
            <div>
              <dt className="text-[10px] uppercase tracking-[0.2em] text-white/40">Prize Target</dt>
              <dd className="mt-1 text-white">$35,000 first prize</dd>
            </div>
            <div>
              <dt className="text-[10px] uppercase tracking-[0.2em] text-white/40">Builder</dt>
              <dd className="mt-1 text-white">Veil team — Sui Overflow 2026</dd>
            </div>
            <div>
              <dt className="text-[10px] uppercase tracking-[0.2em] text-white/40">Stack</dt>
